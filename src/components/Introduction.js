  ...
  const contacts = [
    {
      ...
      link: "https://github.com/NHViet03",
    },
    {
      name: "LinkedIn",
      icon: "fa-brands fa-linkedin-in",
      link: "https://www.linkedin.com/in/hviet03/",
    },
    {
      name: "Facebook",
      icon: "fa-brands fa-facebook-f",
      link: "https://www.facebook.com/NgyenHoangViet",
    },
  ];
        ...
        <div className="intro_content col col-7">
          <div className="intro_content_content">
            ...
            <p>
              ...
              back-end development using JavaScript, React, React Native,
              Node.js, and SQL. Demonstrated ability to contribute to
